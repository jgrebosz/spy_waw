...
class Tuser_spectrum
{
    ...
    std::vector<Tincr_entry> x_incr_addresses ;
    std::vector<Tincr_entry> y_incr_addresses ;
    Tuser_condition * cond_ptr ;
    bool * cond_result_ptr ;
    bool flag_mutative_named_pointers_are_used;
...
// 		std::map<std::string, Tself_gate_abstract_descr* > map_of_selfgates;
...
protected: // Protected methods
    ...
    Tself_gate_abstract_descr*  address_of_self_gate ( std::string sg_name );
    /** No descriptions */
...
public:
    ...
    perhaps_deprecated_name_of_incrementer ( Tmap_of_named_pointers & np, std::string str );
};

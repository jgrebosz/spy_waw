...
/**FRS scalers
  ...
  */
////////////////////////////////////////////////////////////////////////
class Tscaler : public TNeedle_element,  public Tincrementer_donnor
{
protected:
    int TGalileoEvent::*data_ptr;
    unsigned long long TGalileoEvent::*time_of_the_measurement_in_seconds ;
...
public:
    Tscaler(std::string _name, int TGalileoEvent::*data,   unsigned long long TGalileoEvent::*seconds_) ;
    ~Tscaler();

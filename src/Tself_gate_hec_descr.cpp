...
void Tself_gate_hec_descr::read_definition_from(std::string pathed_name)
{
    ...
    try
    {
        ...
        //    unsigned int i = name.find( ".self_gate_hec_crystal"); // != std::string::npos)
        //    if(i == std::string::npos)
        //    {
        //      name += ".self_gate_hec_crystal" ;
        //    }

        enable_energy_fast_gate = (bool) Tfile_helper::find_in_file<bool>(plik, "enable_energy_fast_gate");
...
void Tself_gate_hec_descr::write_definitions(std::string path_only)
{
    ...
    //  if(file_name.find(".self_gate_hec_crystal") == std::string::npos)
    //  {

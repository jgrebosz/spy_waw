...
DO Not use it. Use file with extension  *.CPP
...
Tself_gate_ger_addback_descr::Tself_gate_ger_addback_descr()
{
    ...
    // for addback SECONDARY cristal (highest energy)
...
//*********************************************************************
void Tself_gate_ger_addback_descr::read_definition_from(std::string pathed_name)
{
    ...
    try
    {
        ...
        try
        {
            ...
            if(enable_energy_time_polygon_gate)
            {
                ...
                {
                    std::cout << "During Reading-in the self gate named "
                         << name
...
//*************************************************************************
void Tself_gate_ger_addback_descr::write_definitions(std::string path_only)
{
    ...
    plik
            ...
            << "type_of_self_gate\t\t" << type << "\t\t// 1= Ger cristal, 2= Hec BaF, 3 miniball, 4 Clust addback\n"
            << "name\t\t " << name

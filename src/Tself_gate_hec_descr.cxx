...
Tself_gate_hec_descr::Tself_gate_hec_descr()
{
    ...
    type = Hector_BaF_cristal ; // this is hector
...
//*********************************************************************
void Tself_gate_hec_descr::read_definition_from(std::string pathed_name)
{
    ...
    {
        type = unknown;
        if((int) fif(plik, "type_of_self_gate") == Hector_BaF_cristal) type = Hector_BaF_cristal;
...
//    unsigned int i = name.find( ".self_gate_hec_cristal"); // != std::string::npos)
...
//*************************************************************************
void Tself_gate_hec_descr::write_definitions(std::string path_only)
{
    std::string file_name = path_only + name;

//  if(file_name.find(".self_gate_hec_cristal") == std::string::npos)
//  {

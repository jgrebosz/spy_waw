...
#define fifbool(x,y) Tfile_helper::find_in_file<bool>((x),(y))
//********************************************************************
...
//*********************************************************************
void Tself_gate_mib_descr::read_definition_from(std::string pathed_file_name)
{    
//    std::string pathed_file_name = pathed_file_name ;

    std::ifstream plik(pathed_file_name.c_str());
    if(!plik)
    {
        std::cout << "Can't open the file "  << pathed_file_name
...
//        plik >> sg_type ; //  type.miniball = Tselfgate_type(typ_nr);
        ...
        //    unsigned int i = name.find( ".self_gate_mib_crystal"); // != std::string::npos)
        //    if(i == std::string::npos)
        //    {
        //      name += ".self_gate_mib_crystal" ;
        //    }

        enable_core_energy_gate = (bool) Tfile_helper::find_in_file<bool>(plik, "enable_core_energy_gate");
...
//*************************************************************************
void Tself_gate_mib_descr::write_definitions(std::string path_only)
{
    std::string file_name = path_only + name;

    //  if(file_name.find(".self_gate_mib_crystal") == std::string::npos)
    //  {

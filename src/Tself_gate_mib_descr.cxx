...
{
    type =  miniball_cristal ;    // this is mibmanium
...
//*********************************************************************
void Tself_gate_mib_descr::read_definition_from(std::string pathed_name)
{


    std::string file_name = pathed_name ;
    // path.user_def_spectra + name_of_spectrum + ".self_gate_mib_cristal" ;
    ...
    {
        type = unknown;
        if((int) fif(plik, "type_of_self_gate") == miniball_cristal) type = miniball_cristal;
...
//    unsigned int i = name.find( ".self_gate_mib_cristal"); // != std::string::npos)
...
//  if(file_name.find(".self_gate_mib_cristal") == std::string::npos)
//  {

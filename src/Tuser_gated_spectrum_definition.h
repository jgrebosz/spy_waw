...
public: 
  ...
  void read_definition_from(std::string name);
//  void read_from(std::string path);
	~Tuser_gated_spectrum_definition();
  /** save the definition on the disk */
  void write_definitions(std::string path);
//protected: // Protected attributes
  ...
  enum type_of_data { energy_cal = 1, energy20_cal, time_cal,   
				  energy_doppl, energy20_doppl } ;
  ...
  double end;
   ...
   //------------------- PHI  & THETA of crystal geometry position-----------
  /** gate on the theta angle of crystal geometry position*/
  bool enable_gate_on_phi_crystal;
  /** left edge of the theta of crystal geometry position */
  double phi_crystal_low;
  /** right edge of the theta of crystal geometry position */
  double phi_crystal_high ;

  /** gate on the phi angle of crystal geometry position*/
  bool enable_gate_on_theta_crystal;
  /** left edge of the phi of crystal geometry position */
  double theta_crystal_low;
  /** right edge of the phi of crystal geometry position */
  double theta_crystal_high ;

  
   /** gate on the time information comming from the germanium crystals */

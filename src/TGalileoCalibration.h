...
//#include "TGalileoLpar.h"
#include "TGalileoPar.h"

/**
 * Class containing the calibration parameters for EB event example. 
 */
class TRisingCalibration //: public TGo4EventCalibration
   {
   public:
     ...
     TGalileoPar fxParams; 

      TRisingCalibration() ;

      virtual ~TRisingCalibration() ;

//ClassDef(TRisingCalibration,1)

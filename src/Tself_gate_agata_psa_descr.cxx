...
#define fifint(x,y) Tfile_helper::find_in_file<int>((x),(y))
...
//*********************************************************************
void Tself_gate_agata_psa_descr::read_definition_from(std::string pathed_name)
{
...
//    unsigned int i = name.find( ".self_gate_aga_crystal"); // != std::string::npos)
//    if(i == std::string::npos)
//    {
//      name += ".self_gate_aga_crystal" ;
//    }

        enable_energy_gate = (bool) Tfile_helper::find_in_file<bool>(plik, "enable_energy_gate");
...
//*************************************************************************
void Tself_gate_agata_psa_descr::write_definitions(std::string path_only)
{
    std::string file_name = path_only + name;

//  if(file_name.find(".self_gate_aga_crystal") == std::string::npos)
//  {

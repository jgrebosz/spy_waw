...
#define fif(x,y) Nfile_helper::find_in_file<double>((x),(y))
#define fifbool(x,y) Nfile_helper::find_in_file<bool>((x),(y))
//********************************************************************
...
//*********************************************************************
void Tself_gate_ge_galileo_descr::read_definition_from(std::string pathed_name)
{
    ...
    try
    {
        ...
        //    unsigned int i = name.find( ".self_gate_ger_crystal"); // != std::string::npos)
        //    if(i == std::string::npos)
        //    {
        //      name += ".self_gate_ger_crystal" ;
        //    }

        enable_en4gate = (bool) Nfile_helper::find_in_file<bool> (plik, "enable_en4gate");
...
//*************************************************************************
void Tself_gate_ge_galileo_descr::write_definitions(std::string path_only)
{
    std::string file_name = path_only + name;

    //  if(file_name.find(".self_gate_ger_crystal") == std::string::npos)
    //  {

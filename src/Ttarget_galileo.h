/***************************************************************************
                          ttarget_galileo.h  -  description
                             -------------------
    begin                : Fri May 23 2003
    copyright            : (C) 2015 by Jurek Grebosz (IFJ Krakow, Poland)
    email                : jerzy.grebosz@ifj.edu.pl
***************************************************************************/

#ifndef TTARGET_GAL_H
#define TTARGET_GAL_H
...
/**this class is to perform operation of tracing the projectile hitting 
   ...
   *@author dr. hab. Jerzy Grebosz (IFJ Krakow, Poland)
   */
////////////////////////////////////////////////////////////////////////////
class Ttarget_galileo : public TNeedle_element, public Tincrementer_donnor
{
 public: 
  Ttarget_galileo(std::string name_of_target,
  ...
  /** No descriptions */
  inline double give_z() { return distance ;}
  /** No descriptions */
  ...
  bool is_doppler_possible(){ return flag_doppler_possible ; }
  
  double give_cate_hit_pos_x() { return cate_after->give_x() ; }
  double give_cate_hit_pos_y() { return cate_after->give_y() ; }
  double give_cate_hit_pos_z() { return cate_after->give_distance() - distance; }
  ...
  double give_betaN_after_target(int n) { return betaN_after_target[n]; }
  bool is_beta_playfield_enabled()  { return beta_playfield_enabled; }
...
//  void isotope_was_identified();
  ...
  double give_x_on_cate() { return x_on_cate; }
  double give_y_on_cate() { return y_on_cate; }

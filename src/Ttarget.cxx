...
//************************************************************************
Ttarget::Ttarget(std::string name_of_target,
...
//**************************************************************************
void  Ttarget::make_preloop_action(std::ifstream & s )
{
    ...
    Tcristal::set_doppler_corr_options(
        tracking_position_on_target,
        tracking_position_on_cate,
        which_doppler_algorithm);
    Tcristal_ge::set_doppler_corr_options(
        tracking_position_on_target,
        tracking_position_on_cate,
        which_doppler_algorithm);
...
void Ttarget::analyse_current_event()
{
    ...
    TGalileoAnalysis::fxCaliEvent->target_x_pos = x_tracked;
    TGalileoAnalysis::fxCaliEvent->target_y_pos = y_tracked;

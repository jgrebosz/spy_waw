...
public:
    ...
    virtual   ~TH1()
    {
        // std::cout << "destructor ~TH1 " << std::endl;
    ...
    virtual  void Reset()
    {
//         std::cout << "Empty f. TH1::Reset()   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" << std::endl;
    }

    virtual int GetBinContent ( int i ) = 0;
    //     {
    //         std::cout << "PUSTA babstrakcyjna f. TH1::GetBinContent(int i = " << i << ") dla widma "
    //         << name
    //         << std::endl;
    //         return 0;
    //
...
//                 std::cout << "TH1::GetBinContent ( int " << binx << ", int " << biny
//                 << ") dla widma " << GetName() << std::endl;
    ...
    //     {
    //         std::cout << "abstrakcyjna f. AddBinContent(int) - trzeba implementowac. Widmo: "
    //         << name << std::endl;
    //     }

    virtual void AddBinContent ( int, double w ) = 0;
    //     {
    //         std::cout << "abstrakcyjna f. AddBinContent(int, double) - trzeba implementowac.  Widmo: "
    //         << name
    //         << std::endl;
    //     }
    ...
    {
//        std::cout << " virtual int SetBinContent ( int binx, int biny, content_type content )  -> binx=" << binx
//        << ", biny = " << biny
//        << ", content=" << content << std::endl;
        SetBinContent ( binx, biny, 0, content );
    }
    virtual int SetBinContent ( int binx, double val )
    {
//       std::cout << " virtual int SetBinContent ( int binx, double val )  -> " << binx << ", val=" << val << std::endl;
...
public:
    ...
    ~TH1I()
    {
//       std::cout << "destructor ~TH1I " << std::endl;
        delete [] fArray;
    }
    ...
    void Reset()
    {
//         std::cout << "f. TH1I::Reset()" << std::endl;
        // zeroing
    ...
    {
        //         std::cout << "f. TH1I::AddBinContent(int, double) - trzeba implementowac.  Widmo: "
        //         << name
        //         << std::endl;
...
//         std::cout << "Ctor  TH2I " << std::endl;
        ...
        fArray = new double[fNcells];
//         std::cout << "zeroing inside Ctor  TH2I " << std::endl;
...
// 	Reset();   <--- non existing
    ...
    void Reset()
    {
//         std::cout << "f. TH2I::Reset()" << std::endl;
        // zeroing
        memset ( fArray, 0, fNcells * sizeof ( double ) );
    }
    ~TH2I()
    {
//       std::cout << "destructor ~TH2I " << std::endl;
        delete [] fArray;
    }
    ...
    {
        //std::cout << "2::Fill(double x, double y) " << std::endl;
        ...
        {
            std::cout << "Before incrementation , binx = "
                 << binx
                 << ", biny = " << biny
                 << ", bin = " << bin << std::endl;
        }

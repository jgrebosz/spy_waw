...
//////////////////////////////////////////////////////////////////////////////
class Tone_signal_pattern_module : public TNeedle_element , public Tincrementer_donnor
{
 ...
 public:
  //  constructor
  Tone_signal_pattern_module (std::string _name, int TGalileoEvent::*first_ptr) ;

  void analyse_current_event() ;
  void make_preloop_action(std::ifstream & );  // read the calibration factors, gates
  unsigned int give_value() { return signal_data; }

 ...
 */
//////////////////////////////////////////////////////////////////////
class Tcate : public TNeedle_element, public Tincrementer_donnor
{
...
protected:
  ...
  std::vector<spectrum_abstr*> cate_spectra_list ;

  std::vector<Tcate_telescope *>  telescope ;     // nine segments of the Cate detector

 public:
  Tcate(std::string name, std::string name_of_silicon_at_target);   // distance is refering to the silicon !
  ~Tcate();

  //-------------------------------
  std::vector< spectrum_abstr*>*  give_spectra_pointer()
  {
  ...
  inline bool was_dE_E_ok() { return dE_E_ok; }
  ...
  inline double give_distance() { return distance ; }
...
//  bool segment_known();
  ...
  /** No descriptions */
  double give_E(){ return E; }
  /** No descriptions */
  double give_dE(){ return dE; }
  /** No descriptions */
...
public:
  ...
  int give_id_of_fired() { return  flag_only_one_hit ? id_of_fired : -1 ; }

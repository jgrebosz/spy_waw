...
{
//   std::cout << "TH1::SetBinContent(int binx, int biny, int binz, content_type content) " ; //<< std::endl;
//      std::cout << "  binx=" << binx 
//        << ", biny = " << biny 
//        << ", binz = " << binz 
...
//     std::cout << "Before call, bin do takich wsolrzednych =" << bin << std::endl;
...
//     {
//         std::cout << "abstrakcyjna f. TH1::GetBinContent(int, int) " << std::endl;
//         return 0;
//     }
*/

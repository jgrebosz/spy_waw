...
/////////////////////////////////////////////////////////////////////////////
class Tsi_detector : public Tincrementer_donnor, public TNeedle_element
{
protected:
  TNeedle * owner; //!
  ...
  double low_g[4] ;   // have to be double, bec grebware stores value of gates as double
  double high_g[4] ;
...
//   cate_segment  *event_si_detector_data ;
 ...
 public:
  ...
  Tsi_detector(std::string name, cate_segment (TGalileoEvent::*ptr));

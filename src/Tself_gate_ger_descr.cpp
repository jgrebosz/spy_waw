...
//*********************************************************************
void Tself_gate_ger_descr::read_definition_from(std::string pathed_name)
{
...
//      plik >> sg_type;
    ...
    {
      std::cout << "No infor in the selfgate file about enabeling/disabling  time diference, so I assume -> False " << std::endl;
...
//*************************************************************************
void Tself_gate_ger_descr::write_definitions(std::string path_only)
{

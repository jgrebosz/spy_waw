...
virtual void SetConfig(uint16_t on_off,uint16_t basetime,uint16_t trig,uint16_t signal,uint16_t channel);
...
virtual void SetChannelIdx(uint16_t idxch,uint16_t idxboard);
